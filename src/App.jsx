...
function App() {
  ...
  const fetchItems = () => {
    fetch(
      "https://bookstorev2-10f9b-default-rtdb.europe-west1.firebasedatabase.app/books/.json"
    )
  ...
  const deleteTodo = (id) => {
    fetch(
      `https://bookstorev2-10f9b-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
      {
        method: "DELETE",
      }
    )
